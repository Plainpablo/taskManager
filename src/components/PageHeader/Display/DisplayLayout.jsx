...
export const DisplayLayout = () => {
  ...
  return (
    <div className="p-1 bg-[#f5f5f5] rounded-[10px] grid grid-cols-3 m-[6px]">
      ...
      {/* <label className="px-1 pt-1 pb-2 flex flex-col justify-center items-center bg-white rounded-[8px] border-[#eee] border-[1px]">
        <div className="size-6 flex justify-center items-center">
          <List size={16} color="#202020" />
        </div>
        <span className="text-[#202020] font-normal text-xs">HELLLO</span>
      </label>

      <label className="px-1 pt-1 pb-2 flex flex-col justify-center items-center bg-white rounded-[8px]">
        <div className="size-6 flex justify-center items-center">
          <List size={16} color="#202020" />
        </div>
        <span className="text-[#202020] font-normal text-xs">HELLLO</span>
